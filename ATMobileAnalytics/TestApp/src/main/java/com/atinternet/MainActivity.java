    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.crash:
                ...
                break;
            case R.id.mvTesting:
                MvTesting mvt = tracker.MvTestings().add("1[My_first__first__first_]", 1, "2[Version2_page_subscription]");
